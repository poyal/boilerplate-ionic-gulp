...
(function() {
  ...
  angular.module('app.tab')
    .controller('ChatsCtrl', ['$scope', 'Chats', ChatsCtrl])
    .controller('ChatDetailCtrl', ['$scope', '$stateParams', 'Chats', ChatDetailCtrl]);
